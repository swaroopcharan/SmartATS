...
with a deep understanding of every job field. Your task is to evaluate the resume based on the given job description.
...
Give the existing jobs that matches the profile and can be applied give their links clearly.
do not create any example domains give existing ones. Check the skills required and correctly with high accuracy
resume:{text}
description:{jd}

I want the below response in Headings and details format. Do not involves any JSON style.
